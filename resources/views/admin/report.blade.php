            ...
            <tbody class="text-white">
                ...
                @foreach($albums as $album)
                    ...
                    <tr class="bg-gray-700 border-b hover:bg-gray-600">
                        <td class="py-3 px-6 text-center">{{ $album->id }}</td>
                        <td class="py-3 px-6 text-center">
                            @if($album->photo)
                                <img src="{{ asset('images/albums/' . $album->photo) }}" alt="Album Cover" class="w-20 h-20 mx-auto object-cover rounded-lg">
                            @else
                                <p class="text-red-500">No Cover</p>
                            @endif
                        </td>
