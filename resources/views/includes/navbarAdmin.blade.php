<nav class="flex items-center sticky-top justify-between p-3 py-6 lg:px-8 bg-gray-700" aria-label="Global">
    <div class="flex lg:flex-1">
        <a href="{{ route('admin.home') }}" class="-m-1.5 p-1.5">
    ...
    <div class="hidden lg:flex lg:gap-x-12">
        <a href="{{ route('admin.albumList') }}" class="text-xl font-raleway font-bold leading-6 text-green-400 dark:text-gray-100">Album List</a>
        <a href="{{ route('admin.transactionList') }}" class="text-xl font-raleway font-bold leading-6 text-green-400 dark:text-gray-100">Transactions</a>
        <a href="{{ route('admin.report') }}" class="text-xl font-raleway font-bold leading-6 text-green-400 dark:text-gray-100">Report</a>
