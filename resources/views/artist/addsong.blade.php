    ...
    <h1 class="text-green-400 text-center font-raleway font-bold text-3xl my-10">Add New Song</h1>

    <div class="max-w-2xl mx-auto my-10 bg-gray-800 border border-gray-700 rounded-lg shadow-lg p-8">
        <form action="{{ route('artist.createSong', ['album' => $album->id]) }}" method="POST">
            @csrf
